...
const Contact = ({ page }) => {
  ...
  return (
    <div>
      ...
      {page === 10 && (
        <Animated animationIn="fadeOut" animationInDuration={4000}>
          <section className="py-12 lg:h-[calc(100vh_-_56px)] lg:flex lg:flex-col lg:justify-center lg:items-center lg:pb-40">
            <h3 className="text-3xl font-bold text-center font-metro text-main-pink-color">
              Contact
            </h3>
            <form className="w-full md:w-8/12 lg:w-6/12 xl:w-4/12 md:mx-auto mt-12">
              ...
              <textarea
                ...
                placeholder="You can always say hi to me :)"
              ></textarea>
              <button className="w-24 h-9 bg-white border border-black font-overpass font-bold text-sm block ml-auto mx-6">
                Send
              </button>
            </form>
            <div className="flex w-full justify-center items-center gap-12 mt-8">
